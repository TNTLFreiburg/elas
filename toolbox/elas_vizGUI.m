...
if strcmp(get(hObject,'Visible'),'off')
    ...
    for a = 1:size(varargin{1}.groups,2)
        handles.params.h2(a) = plot3( ...
                        varargin{1}.xyz(varargin{1}.groups{1,a},1), ...
                        varargin{1}.xyz(varargin{1}.groups{1,a},2), ...
                        varargin{1}.xyz(varargin{1}.groups{1,a},3),'b*');
    end
        
    % plot brain 
    patch('Faces', [varargin{4}.fS(:,2), ...
                    varargin{4}.fS(:,1), ...
                    varargin{4}.fS(:,3)], ...
          'Vertices', [varargin{4}.vS(:,2), ...
                       varargin{4}.vS(:,1), ...
                       varargin{4}.vS(:,3)], ...
...
if get(hObject,'Value') == 1
    set(handles.params.h2(group_tag), 'Visible', 'on')
else
    set(handles.params.h2(group_tag), 'Visible', 'off')
end
