...
if strcmp(get(hObject,'Visible'),'off')
    ...
    % plot brain 
    S = varargin{2};
    patch('Faces', [S.fS(:,1),S.fS(:,2),S.fS(:,3)], ...
          'Vertices', [S.vS(:,1),S.vS(:,2),S.vS(:,3)], ...
...
if handles.params.nc <= handles.params.lc
    ...
    plot3(handles.params.coordsX(1:handles.params.nc-1), ...
          ...
          handles.params.coordsZ(1:handles.params.nc-1), ...
